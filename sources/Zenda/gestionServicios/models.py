...
class Presupuesto(models.Model):
    ...
    def calcularTotal(self):
        '''metodo temporal para mostrar el total en el form'''
        total=0
...
class Solicitado(EstadoPresupuesto):
    ...
    def valorizar(self):
        estado = Valorizado(
                            ...
                            valor_final = self.presupuesto.calcularTotal(),
                            )   
        estado.save()
...
class Valorizado(EstadoPresupuesto):
    ...
    def confirmar(self):
        ...
        contrato.presupuesto = self.presupuesto


    def rechazar(self, motivo):
        estado = Rechazado.objects.objects.create(nombre = 'Rechazado',
                                                  presupuesto = self.presupuesto,
...
class Rechazado(EstadoPresupuesto):
    rechazado = models.DateTimeField()
